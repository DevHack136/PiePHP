<div style="margin-top: 40vh; transform: translateY(-50%);">
    ...
    <form style="display: flex; flex-direction: column; align-items: center;" method="POST" action="./loginDB">
        ...
        <!-- <br> -->
        <!-- <br> -->
        <input type="submit" value="👉Connexion👈" style="font-weight: bold; font-size: 17px;">
    </form>
</div>